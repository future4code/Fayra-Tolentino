...
import {goBack} from '../components/routes/cordinator'
    ...
    return (
        <div className="CreateTrip">
            ...
            <form>
                ...
                <input value={description} onChange={handleDescription} placeholder="Descrição" type ='string' pattern={"(.*[a-z]){30}"} required />
